    ...
    describe("getStart", () => {
        ...
        describe("year", () => {
            it("should get the next year", () => {
                const tf = new TimeFrame({ year: { value: 1 } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
            ...
            it("should set the year to 2010", () => {
                const tf = new TimeFrame({ year: { value: 2010, fixed: true } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
        ...
        describe("month", () => {
            it("should get the next month", () => {
                const tf = new TimeFrame({ month: { value: 1 } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
            ...
            it("should set the month to January", () => {
                const tf = new TimeFrame({ month: { value: 1, fixed: true } }, {}, baseRecurrence);
        ...
        describe("day", () => {
            it("should get the next day", () => {
                const tf = new TimeFrame({ day: { value: 1 } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
            ...
            it("should set the day to the first", () => {
                const tf = new TimeFrame({ day: { value: 1, fixed: true } }, {}, baseRecurrence);
        ...
        describe("hour", () => {
            it("should get the next hour", () => {
                const tf = new TimeFrame({ hour: { value: 1 } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
            ...
            it("should set the hour to 0", () => {
                const tf = new TimeFrame({ hour: { value: 0, fixed: true } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
        ...
        describe("minute", () => {
            it("should get the next minute", () => {
                const tf = new TimeFrame({ minute: { value: 1 } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
            ...
            it("should set the minute to 0", () => {
                const tf = new TimeFrame({ minute: { value: 0, fixed: true } }, {}, baseRecurrence);
                const start = tf.getStart(baseDate);
